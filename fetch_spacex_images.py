...
def main():
    ...
    parser_id = argparse.ArgumentParser(description='Получает ваш id фотографий запуска')
    parser_id.add_argument("--id", help="Получает ваш id фотографий запуска", default='5eb87d47ffd86e000604b38a')
